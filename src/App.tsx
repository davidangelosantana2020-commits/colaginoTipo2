      ...
      <section className="py-20 px-6 max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div className="mt-10 flex gap-4">
            <button className="bg-blue-900 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-blue-800 transition">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8 items-center">
            ...
            <div className="bg-white p-8 rounded-3xl border text-center shadow-sm">
                ...
                <div className="text-4xl font-bold mt-6">R$ 147</div>
            </div>
            {/* Kit 5 */}
            <div className="bg-blue-900 text-white p-8 rounded-3xl border-4 border-yellow-500 text-center relative shadow-xl transform md:scale-105">
                ...
                <div className="text-5xl font-bold mt-6">R$ 397</div>
                <button className="bg-yellow-500 text-blue-900 w-full py-4 rounded-full font-bold mt-8 hover:bg-yellow-400 transition">Comprar Agora</button>
            </div>
            {/* Kit 3 */}
            <div className="bg-white p-8 rounded-3xl border text-center shadow-sm">
                ...
                <div className="text-4xl font-bold mt-6">R$ 297</div>
            </div>
          </div>
        </div>
      </section>
